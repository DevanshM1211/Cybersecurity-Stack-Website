  ...
  const team = [
    {
      ...
      role: "Co-founder",
      description:
        "Turning breakthrough integrity research into practical security products. Luke leads technological strategy and development to help our clients build ransomware-resilient systems.",
