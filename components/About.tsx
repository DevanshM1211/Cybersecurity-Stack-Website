        ...
        >
          ...
          <div className="space-y-6 text-left">
            ...
            <p className="text-base md:text-lg leading-relaxed text-gray-700 dark:text-gray-400">
              The Resonance Protocol is not a single product or agent. It
              represents a new approach to digital architecture, embedding
              verifiable trust and integrity deep into the fabric of digital
              ecosystems. This is Zero Trust Architecture realised at its most
              fundamental level, extending from firmware, kernel, and chip,
              through operating systems and runtime environments, and across
              IoT, OT, and IT infrastructures.
            </p>
